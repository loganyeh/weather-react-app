        ...
        <>
            <div id="home-page-borders" className="h-screen w-screen grid grid-rows-12 grid-cols-12 text-white font-mono" style={{backgroundColor: colors.neutral900}}>
                ...
                <div onClick={handleConsoleReset} className="h-full w-full flex justify-center items-center row-start-1 row-end-2 col-start-2 col-end-4 cursor-pointer overflow-visible">
                    <img className="h-11/12 w-full object-contain" src={logo} alt="weather app logo" />
                ...
                <div className="flex justify-between items-end pl-22 pr-26 pt-5 row-start-3 row-end-4 col-start-4 col-end-11">                    
                    <div className="h-full w-4/5 flex justify-center items-center border-2 border-black rounded-2xl" style={{backgroundColor: colors.neutral700, border: `2px solid ${colors.neutral300}`}}>
                        <img onClick={handleIsSearchDropdown} className="h-1/2 w-1/12 rounded-l-2xl object-contain cursor-pointer" src={search} alt="" />
                        <input className="h-full w-11/12 text-white" type="text" placeholder="Search for a place..." />
                    </div>
                    <button className="h-full w-1/6 border-2 border-black rounded-2xl text-xl hover:bg-red-700 active:bg-gray-200 cursor-pointer" style={{backgroundColor: colors.blue500}}>Search</button>
                </div>
                ...
                <div className="grid grid-rows-6 grid-cols-5 row-start-4 row-end-8 col-start-2 col-end-10 my-4 mr-32 border-2 border-blue-900 rounded-3xl bg-no-repeat bg-cover bg-center" style={{backgroundImage: `url(${bgTodayLarge})`}}>
                    <h1 className="flex items-end pl-5 pb-2 row-start-2 row-end-4 col-start-1 col-end-3 text-4xl">Berlin, Germany</h1>
                    <h2 className="flex justify-start pl-5 pt-2 row-start-4 row-end-6 col-start-1 col-end-3 text-lg">Tuesday. Aug 5, 2025</h2>
                    <img className="h-full w-full row-start-2 row-end-6 col-start-4 col-end-5 object-contain" src={sunny} alt="weather-img" />
                    <h1 className="h-full w-full flex justify-center items-center pr-8 row-start-2 row-end-6 col-start-5 col-end-6 font-sans text-9xl">20°</h1>
                </div>
                ...
                <div className="flex justify-between my-1 row-start-8 row-end-10 col-start-2 col-end-10 mr-32 mb-6">
                    ...
                    <div className="h-full w-64 rounded-3xl shadow-2xl" style={{backgroundColor: colors.neutral800, border: `2px solid ${colors.neutral600}`}}>
                        <h3 className="flex items-center pl-6 h-1/2 w-full text-lg rounded-t-3xl">Feels Like</h3>
                        <h3 className="flex items-center pl-6 h-1/2 w-full text-3xl rounded-b-3xl">18°</h3>
                    </div>

                    <div className="h-full w-64 rounded-3xl shadow-2xl" style={{backgroundColor: colors.neutral800, border: `2px solid ${colors.neutral600}`}}>
                        <h3 className="flex items-center pl-6 h-1/2 w-full text-lg rounded-t-3xl">Humidity</h3>
                        <h3 className="flex items-center pl-6 h-1/2 w-full text-3xl rounded-b-3xl">46%</h3>
                    </div>


                    <div className="h-full w-64 rounded-3xl shadow-2xl" style={{backgroundColor: colors.neutral800, border: `2px solid ${colors.neutral600}`}}>
                        <h3 className="flex items-center pl-6 h-1/2 w-full text-lg rounded-t-3xl">Wind</h3>
                        <h3 className="flex items-center pl-6 h-1/2 w-full text-3xl rounded-b-3xl">14 km/h</h3>
                    </div>


                    <div className="h-full w-64 rounded-3xl shadow-2xl" style={{backgroundColor: colors.neutral800, border: `2px solid ${colors.neutral600}`}}>
                        <h3 className="flex items-center pl-6 h-1/2 w-full text-lg rounded-t-3xl">Precipitation</h3>
                        <h3 className="flex items-center pl-6 h-1/2 w-full text-3xl rounded-b-3xl">0 mm</h3>
                    </div>
                </div>
                ...
                <div className="flex flex-col justify-around row-start-10 row-end-13 col-start-2 col-end-10 mr-32">
                    ...
                    <div className="h-10/12 w-full flex justify-between items-center">
                        ...
                        {/* 1 */}
                        <div className="h-11/12 w-32 rounded-3xl" style={{backgroundColor: colors.neutral800, border: `2px solid ${colors.neutral600}`}}>
                ...
                {/* HOURLY FORECAST */}
                <div className="flex flex-col row-start-4 row-end-13 col-start-9 col-end-12 mt-4 ml-16 mb-3 border-2 border-red-600 rounded-3xl" style={{backgroundColor: colors.neutral800, border: `2px solid ${colors.neutral700}`}}>
                    ...
                    <div className="h-14 w-full pt-2 flex justify-around items-center">
                        ...
                        <h3 onClick={handleIsHourlyForecastDropdown} className="h-10 w-4/12 flex justify-center items-center text-sm hover:bg-gray-300 active:bg-gray-200 rounded-xl cursor-pointer" style={{backgroundColor: colors.neutral600, border: `2px solid ${colors.neutral700}`}}>Tuesday \/</h3>
                    </div>

                    <div className="h-11/12 w-full flex flex-col justify-around items-center">

                        {/* 1 */}
                        <div className="h-15 w-90 flex justify-between rounded-2xl" style={{backgroundColor: colors.neutral700, border: `2px solid ${colors.neutral600}`}}>
